...
class Carousel04 extends React.Component {
    ...
    constructor(props) {
        ...
        //     if (this.navbar) {
        //         console.log('Carousel04.printNavBar: this.navbar.style.backgroundColor = ' + this.navbar.style.backgroundColor)
        //     }
        // };
    }

    handleScroll(event) {
        // console.log('Carousel04.handleScroll: document.body.scrollTop = ' + document.body.scrollTop + ', document.documentElement.scrollTop = ' + document.documentElement.scrollTop + ', window.scrollY = ' + window.scrollY)
        ...
        // var navbar = document.querySelector(".navbar");
        // if (navbar) {
        //     console.log('Carousel04.handleScroll: navbar.style.backgroundColor = ' + navbar.style.backgroundColor)
        // }
        //this.printNavBar();
        // if (this.navbarRef && this.navbarRef.current)
        //     console.log('Carousel04.handleScroll: this.navbarRef.current.style.backgroundColor = ' + this.navbarRef.current.style.backgroundColor)
    ...
    render() {
        return (
            <>
                <header>
                    <Navbar expand="md" bg="dark" variant="dark" fixed="top" className="bg-transparent" ref={this.setNavBarRef}>
                        <Container fluid>
                            <Navbar.Brand href="#">
                                <img
                                    alt=""
